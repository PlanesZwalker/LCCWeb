...
function updateHTMLFile(filePath) {
    try {
        ...
        // Add enhanced CSS after the last link tag
        ...
        // Clean up duplicate content structure
...
function processAllHTMLFiles() {
    console.log('🎨 Starting improved page uniformization...\n');
    ...
    console.log('\n✨ Improved page uniformization completed!');
